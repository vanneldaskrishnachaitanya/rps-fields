        ...
        {OPTIONS.map((opt, i) => (
          ...
          >
            ...
            <button onClick={e => { e.stopPropagation(); navigate(opt.path); }}
              style={{ background:opt.grad, backdropFilter:"blur(28px) saturate(200%)", WebkitBackdropFilter:"blur(28px) saturate(200%)", color:"#fff", border:"1px solid rgba(255,255,255,0.28)", width:"100%", padding:"12px 0", borderRadius:50, cursor:"pointer", fontWeight:800, fontSize:14, fontFamily:"'Inter',sans-serif", boxShadow:`0 4px 16px ${opt.color}35`, transition:"all 0.2s" }}
