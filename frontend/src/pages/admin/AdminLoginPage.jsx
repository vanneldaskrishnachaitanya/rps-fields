    ...
    <aside style={{
      ...
      <div style={{ padding:"26px 20px 22px", borderBottom:"1px solid rgba(82,183,136,0.1)" }}>
        <div style={{ display:"flex", alignItems:"center", gap:10, marginBottom:4 }}>
          <div style={{ width:34, height:34, borderRadius:9, background:"linear-gradient(135deg,#52b788,#1b4332)", display:"flex", alignItems:"center", justifyContent:"center", fontSize:16, boxShadow:"0 4px 14px rgba(82,183,136,0.3)" }}>🌿</div>
      ...
      <div style={{ width:"100%", maxWidth:420, animation:"scaleIn 0.5s cubic-bezier(0.34,1.56,0.64,1) both" }}>
        <div style={{ background:"rgba(8,18,10,0.88)", backdropFilter:"blur(28px) saturate(200%)", WebkitBackdropFilter:"blur(28px) saturate(200%)", borderRadius:24, padding:"44px 40px", border:"1px solid rgba(82,183,136,0.15)", boxShadow:"0 24px 64px rgba(0,0,0,0.7), inset 0 1px 0 rgba(255,255,255,0.05)", marginBottom:16 }}>
          <div style={{ textAlign:"center", marginBottom:32 }}>
            <div style={{ width:68, height:68, borderRadius:18, background:"linear-gradient(135deg,#52b788,#1b4332)", display:"flex", alignItems:"center", justifyContent:"center", fontSize:30, margin:"0 auto 18px", boxShadow:"0 10px 30px rgba(82,183,136,0.4)", animation:"anim-glow 2s ease-in-out infinite" }}>🛡</div>
          ...
          <div style={{ marginTop:20, padding:"14px 16px", background:"rgba(255,255,255,0.03)", backdropFilter:"blur(8px)", border:"1px solid rgba(82,183,136,0.1)", borderRadius:14 }}>
            ...
            <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center" }}>
              ...
              <button onClick={()=>{ setEmail("admin@rpsfields.in"); setPassword("admin123"); setError(""); }}
                style={{ padding:"7px 14px", background:"linear-gradient(135deg,#52b788,#2d6a4f)", color:"#fff", border:"none", borderRadius:20, cursor:"pointer", fontSize:12, fontWeight:700, fontFamily:"'Inter',sans-serif", boxShadow:"0 3px 10px rgba(82,183,136,0.3)", transition:"all 0.2s" }}
    ...
    <AdminLayout title="👥 User Management">
      <div style={{ display:"flex", gap:6, marginBottom:20, flexWrap:"wrap", padding:6, borderRadius:14, background:"rgba(82,183,136,0.06)", backdropFilter:"blur(8px)", border:"1px solid rgba(82,183,136,0.1)", width:"fit-content" }}>
        {["all","farmer","agent","customer"].map(r=>(
          <button key={r} onClick={()=>setTab(r)} style={{ padding:"7px 16px", borderRadius:10, border:"none", background: tab===r?"linear-gradient(135deg,#52b788,#2d6a4f)":"transparent", color: tab===r?"#fff":A.textMid, cursor:"pointer", fontWeight:700, fontSize:13, fontFamily:"'Inter',sans-serif", boxShadow: tab===r?"0 3px 10px rgba(82,183,136,0.3)":"none", transition:"all 0.2s", textTransform:"capitalize" }}>
