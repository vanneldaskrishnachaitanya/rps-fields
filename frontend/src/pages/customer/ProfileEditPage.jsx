      ...
      <div style={{ maxWidth:520, margin:"0 auto", background:tk.bgCard, borderRadius:20, padding:40, boxShadow:tk.shadowLg, border:`1px solid ${tk.border}` }}>
        ...
        <form onSubmit={handleSave}>
          ...
          <div style={{ display:"flex", gap:12, marginTop:8 }}>
            ...
            <button data-magnetic type="button" onClick={() => navigate("/profile")} style={{ flex:1, padding:13, background:"transparent", border:`1.5px solid ${tk.border}`, color:tk.textMid, borderRadius:10, cursor:"pointer", fontWeight:700, fontFamily:"'Inter',sans-serif" }}>
              Cancel
            </button>
          </div>
        </form>
