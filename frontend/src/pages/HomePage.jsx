...
export default function HomePage() {
  ...
  return (
    <div style={{ background: tk.bg, overflowX: "hidden" }}>
      ...
      <div style={{ background: dark ? "#0f2018" : "#1b4332", width:"100%", position: "relative", overflow: "hidden", minHeight: "120px", display: "flex", alignItems: "center", justifyContent: "center", paddingTop: "20px", paddingBottom: "20px" }}>
        {/* Animated background lines */}
        <div style={{ position: "absolute", right: "30px", top: "50%", transform: "translateY(-50%)", display: "flex", flexDirection: "column", gap: "12px" }}>
          {[...Array(8)].map((_, i) => (
            <div key={i} style={{
              width: `${80 - i * 8}px`,
              height: "2px",
              background: `rgba(82, 183, 136, ${0.8 - i * 0.08})`,
              borderRadius: "2px",
              animation: `slideLineAnim ${1.2 + i * 0.15}s ease-in-out infinite`,
        ...
        <div style={{
          ...
          <div style={{
            ...
            inset: "4px",
            borderRadius: "50%",
            background: "conic-gradient(from 0deg, #52b788 0deg, #74c69d 180deg, transparent 180deg)",
            opacity: 0.7,
            animation: "rotateLoadingReverse 3s linear infinite",
          }} />
          <div style={{
            width: "16px",
            height: "16px",
            borderRadius: "50%",
            background: "#52b788",
            boxShadow: "0 0 12px rgba(82, 183, 136, 0.8)",
            zIndex: 2,
          }} />
        </div>
        ...
        <div style={{
          ...
          {SLIDES.map((_, i) => (
            <div key={i} style={{
              ...
              height: "6px",
              borderRadius: "50%",
              background: i === slide ? "#52b788" : "rgba(82, 183, 136, 0.3)",
              boxShadow: i === slide ? "0 0 8px rgba(82, 183, 136, 0.6)" : "none",
              transition: "all 0.3s ease",
              animation: i === slide ? "pulseLoader 2s ease-in-out infinite" : "none",
            }} />
          ))}
        </div>

        <style>{`
          @keyframes slideLineAnim {
          ...
          @keyframes rotateLoadingReverse {
