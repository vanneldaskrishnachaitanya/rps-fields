          ...
          <nav className="rps-nav" style={{ alignItems:"center", gap:2, flexWrap:"nowrap" }}>
            ...
            {(!user||user.role==="customer") && (
              <button onClick={()=>navigate("/cart")} style={{
                background:"rgba(200,150,12,0.32)", backdropFilter:"blur(28px) saturate(200%)", WebkitBackdropFilter:"blur(28px) saturate(200%)", border:"none", color:"#fff", fontWeight:700, fontFamily:"'Inter',sans-serif",
